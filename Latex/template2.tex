...
\setbeamersize{text margin left=1cm,text margin right=1mm} 
...
\setbeamercolor{frametitle}{fg=purple} % center the title
...
\addtobeamertemplate{frametitle}{\vskip18pt}{} 
...
\setbeamertemplate{headline}{
	\hspace{50pt}  % logo on the right
}
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{blankslide.png}}
\frame{\titlepage}
...
{\includegraphics[width=\paperwidth, height=\paperheight]{TAS_template.pdf}}

\setbeamertemplate{footline}{
\vspace{-0.3cm}\includegraphics[width=0.9\paperwidth,height=0.508cm]{bluebox.pdf}\colorbox{purple!85}{\makebox(1.5,0.4){\textcolor{white}{Page \insertframenumber}}}
}
...
\vspace{0.15cm}
\fbox{
\parbox[c]{0.4\textwidth}{  % little frame around the figure
\includegraphics[width=0.4\textwidth]{example-image-a}  % figure
}
}\\
\vspace{0.5cm}
